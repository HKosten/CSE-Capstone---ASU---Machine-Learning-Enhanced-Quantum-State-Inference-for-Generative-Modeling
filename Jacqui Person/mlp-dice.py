...
#Use last 2 rolls to predict next roll (lagged features, autoregression)
X_data = []
y_data = []
...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc1 =  nn.Linear(2,10)# TO DO !!!!!
        self.fc2 =  nn.Linear(10,6)# TO DO !!!!!
...
# We use SGD (stochastic gradient descent) optimizer with a learning rate of 0.05
...
# predict probability dist. for next roll
